...
const FISH_COLORS = ['#ff6b6b', '#ffd93d', '#6bcb77', '#4d96ff', '#ff9f43', '#fd79a8', '#a29bfe', '#00d2ff']
...
function createFish(i: number, canvasWidth: number, canvasHeight: number): Fish {
  const dir = i % 2 === 0 ? 1 : -1
  return {
...
function createBubble(i: number, canvasWidth: number, canvasHeight: number): Bubble {
  return {
    x: (i * 137) % canvasWidth,
    y: canvasHeight + 20,
    r: 3 + (i % 5) * 3,
